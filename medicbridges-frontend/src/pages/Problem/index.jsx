  ...
  return (
    <div className="page-container" style={{ padding: '0', animation: 'fadeIn 0.6s ease-out' }}>
      ...
      <section style={{ padding: '4rem 2rem', backgroundColor: 'var(--mb-bg-surface)', borderBottom: '1px solid var(--mb-border)' }}>
        <div className="problem-stats" style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '2rem', textAlign: 'center' }}>
          <div>
            <div style={{ fontSize: '3rem', color: 'var(--mb-text-heading)', marginBottom: '0.5rem' }}>44,000+</div>
          ...
          <div>
            <div style={{ fontSize: '3rem', color: 'var(--mb-text-heading)', marginBottom: '0.5rem' }}>38%</div>
            <div style={{ color: 'var(--mb-text-secondary)', lineHeight: 1.5 }}>of Americans delay or avoid care due to cost</div>
          </div>
          <div>
            <div style={{ fontSize: '3rem', color: 'var(--mb-text-heading)', marginBottom: '0.5rem' }}>1 in 4</div>
            <div style={{ color: 'var(--mb-text-secondary)', lineHeight: 1.5 }}>Miami-Dade residents are uninsured or underinsured</div>
          </div>
          <div>
            <div style={{ fontSize: '3rem', color: 'var(--mb-text-heading)', marginBottom: '0.5rem' }}>$0</div>
